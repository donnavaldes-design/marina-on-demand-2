...
function setup(overrides={}) {
  ...
  vm.runInContext(source+'\nmodule.exports.testing={getHighLevelAccessToken,highLevelApi,refreshHighLevelAccessToken,testBmodConnection,completeBmodOAuth};',context);
